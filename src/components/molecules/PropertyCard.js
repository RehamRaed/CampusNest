// src/components/molecules/PropertyCard.jsx
// تم نقل الكود من ملف PropertyCard السابق
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition">
      <div className="h-48 bg-gray-100 relative">
        ...
        <div className="absolute top-2 right-2 rounded-full bg-white/60 px-3 py-2 transition-transform duration-300 hover:scale-103 cursor-pointer"> 
            <i className="bi bi-heart text-gray-800 "></i>
        </div>
      </div>
      <div className="p-4">
        ...
        <div className="flex justify-end align-center">
          <Link href={`/propertyDetails/${property.id}`} className="flex justify-center align-center gap-1 px-3 py-1 text-sm rounded-sm border border-gray-500 cursor-pointer">
