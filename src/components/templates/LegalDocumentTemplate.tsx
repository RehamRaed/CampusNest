...
import { LegalContentItem } from "@/types/legalContent.types";
...
export default function LegalDocumentTemplate({
  ...
  return (
    <>
      {" "}
      <div className="max-w-[1400px] mx-auto pt-10 px-6 text-gray-700">
        {" "}
      ...
      <div className="max-w-[1200px] mx-auto pb-10 px-6 text-gray-700">
        <h1 className="text-2xl md:text-4xl font-extrabold mb-3 text-orange-400">
          {content.title}
        </h1>
