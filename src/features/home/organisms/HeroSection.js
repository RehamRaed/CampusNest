  ...
  return (
    <section className="relative h-[90vh] overflow-hidden flex justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-white text-center px-6 md:px-10 h-full ">
        ...
        <div className="bg-white/85 backdrop-blur-md text-gray-800 rounded-2xl p-5 md:p-6 !mt-10 flex flex-col md:flex-row gap-4 shadow-2xl w-full max-w-5xl items-center animate-slideUp border border-gray-200">
