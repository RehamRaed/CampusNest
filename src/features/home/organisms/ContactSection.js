      ...
      <div className=" mx-auto w-full max-w-[1200px] px-[15px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="space-y-6 flex flex-col justify-center">
            <h2 className="text-[22px] font-bold">Feel free to reach out to Us anytime!</h2>
            <p className="text-[16px] mt-[-18px]">Whether you have questions or need assistance, we’re here 24/7 to support you</p>

            <ContactInfoCard iconName="Mail" title="Email" description="contact@campusnest.com" />
            <ContactInfoCard iconName="Phone" title="Phone" description="+20 123 456 7890" />
            <ContactInfoCard iconName="MapPin" title="Follow Us" description={
