    ...
    <section className="flex justify-center px-4 sm:px-6 lg:px-8 my-20">
      <div className="w-full max-w-[1200px] px-[15px]">
        ...
        <div className="relative flex items-center justify-center">
          <button onClick={prevSlide} className="absolute left-0 z-10 bg-gray-200 hover:bg-gray-300 text-gray-700 py-1 px-2 rounded-full transition cursor-pointer">
          ...
          <button onClick={nextSlide} className="absolute right-0 z-10 bg-gray-200 hover:bg-gray-300 text-gray-700 py-1 px-2 rounded-full transition cursor-pointer">
