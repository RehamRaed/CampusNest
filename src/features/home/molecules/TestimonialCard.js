...
export default function TestimonialCard({ role, name, rating, image, text, visibleCards, index }) {
  return (
    <div className={`flex flex-col items-center text-center bg-white border border-gray-200 rounded-2xl shadow-md p-6 w-[90%] md:w-[300px] transition-all duration-500 ${
      visibleCards === 3
