...
import ReservationBrief from "../organisms/ReservationBrief";
import useReservation from "../hooks/useReservation";

export default function ReservationTemplate({ propertyDetails, selectedGuests }) {
  const {
    currentStep, setCurrentStep,
    selectedPaymentType, setSelectedPaymentType,
    selectedPaymentMethod, setSelectedPaymentMethod,
    selectedAgree, setSelectedAgree
  } = useReservation(propertyDetails.price);
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-8">
        ...
        <div className="lg:w-7/12 space-y-8">
          ...
          <div className="border border-gray-200 p-6 rounded-xl shadow-md">
            ...
            {currentStep === 1 && (
              <PaymentChoices
                basePrice={propertyDetails.price}
