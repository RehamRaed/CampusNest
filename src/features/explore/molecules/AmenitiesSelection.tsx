...
import { AmenitiesSelectionProps } from "@/features/explore/types/explore.types";
    ...
    <div className="relative mb-4" ref={inputRef}>
      ...
      >
        ...
        <input
          ...
          className="flex-grow min-w-[50px] p-1 text-sm bg-transparent outline-none text-gray-700"
        />
      </div>
