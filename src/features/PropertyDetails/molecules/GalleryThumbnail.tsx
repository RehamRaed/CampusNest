import { GalleryThumbnailProps } from "@/features/PropertyDetails/types/propertyDetails.types"
export default function GalleryThumbnail({ img, isActive, onClick } :GalleryThumbnailProps) {
  return (
    <div
      onClick={onClick}
